...
//        show(true);
    ...
    private String xrefreshview_footer_hint_normal;
    public void setString(String s) {
        this.xrefreshview_footer_hint_normal = s;
    }

    public void setString(int stringRes) {
        this.xrefreshview_footer_hint_normal = getResources().getString(stringRes);
    }
    @Override
    public void onStateFinish(boolean hideFooter) {
        if (hideFooter) {
            mHintView.setText(xrefreshview_footer_hint_normal);
        } else {
