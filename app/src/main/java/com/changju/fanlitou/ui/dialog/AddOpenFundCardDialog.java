...
public class AddOpenFundCardDialog extends DialogFragment {

    private OpenFundActivity context;

    private List<OpenFundAccountBean.BanksBean> infoBanks;

    public static AddOpenFundCardDialog newInstance(
            List<OpenFundAccountBean.BanksBean> infoBanks) {

        AddOpenFundCardDialog addOpenFundCardDialog = new AddOpenFundCardDialog();
        addOpenFundCardDialog.infoBanks = infoBanks;

        return addOpenFundCardDialog;
    }
    ...
    private class BankCardAdapter extends BaseQuickAdapter<OpenFundAccountBean.BanksBean,BaseViewHolder>{

        BankCardAdapter(@Nullable List<OpenFundAccountBean.BanksBean> data) {
            super(R.layout.recycler_item_add_bank_card, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, OpenFundAccountBean.BanksBean item) {
